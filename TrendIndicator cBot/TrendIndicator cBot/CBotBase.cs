...
namespace cAlgo
{
    public abstract class CBotBase : Robot
    {
        ...
        protected abstract TradeType Filter(TradeType tradeType, ref double stopLossInPips, ref double risk, ref double tpFactor);
        ...
        protected virtual void OnTrade(double tradeRisk, double tpFactor)
        {
            ...
            tradeType = Filter(tradeType.Value, ref stopLossInPips, ref risk, ref tpFactor);
        ...
        protected virtual void ExecuteOrder(TradeType tradeType, double risk, double stopLossInPips, double tpFactor)
        {
            ...
            volumeInUnits = Math.Min(50000, volumeInUnits);
